function [r,LB,UB] = ICC(M, type, alpha, r0)
...
%% clean the reproducibility inter & intra device tables BUT not full tables are passed : here specific tables like h_pd,t_acd are passed
%the passed variable has 3 cols : 
%eg: t_lv : col1 - lv from image A ; col2- lv from image B ; col3 - difference
%neglect col3 and process cols1 & 2 for removing NaNs
% for i=1:size(M,1)
%     
% end
%% 
